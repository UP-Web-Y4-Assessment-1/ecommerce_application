          ...
          <div className="bg-white shadow-sm p-4 checkout_mainCard">
            <Row>
              <Col
                lg="8"
                md="12"
                className="cutomerinfost checkoutcard-div-style"
              >
                {(activeItem == 0 && <Cart action={orderStepAction} />) ||
                  (activeItem == 1 && (
                    <OrderShippingAddress address={shippingAddress} action={orderStepAction} />
                  )) ||
                  (activeItem == 2 && (
                    <OrderShipping shippingInfo={shippingInfo} />
                  ))}
              </Col>
              ...
              <Col lg="4" md="12" className="margincart">
                <div className="checkout__cart">
                    ...
                    {cartItems?.map((item, index) => {
                      return (
                        <div className="order_item">
                          <div
                            style={{ flexBasis: "30%", position: "relative" }}
                          >
                  ...
                  <h6>
                    ...
                    <span>
                      {" "}
                      {currency} {parseFloat(totalAmount)}
                    </span>
                  </h6>
                </div>
              </Col>
