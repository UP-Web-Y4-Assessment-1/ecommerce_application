...
const UserAddress = () => {
  ...
  let getDistrictList = (divisionId) => {
    axiosClient
      .get(`district/list?divisionId=${divisionId}`)
      .then(({ data }) => {
                  ...
                  <Form>
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            onChange={(data) => {
                              setfirst_nameShippingRef(data.target.value);
                            }}
                            name="first_name"
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            onChange={(data) => {
                              setlast_nameShippingRef(data.target.value);
                            }}
                            name="last_name"
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            onChange={(data) => {
                              setemailShippingRef(data.target.value);
                            }}
                            name="email"
                            placeholder="Email"
                            type="email"
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            value={shippingPhone}
                            onChange={(data) => {
                              setshippingPhone(data.target.value);
                            }}
                            name="last_name"
                            placeholder="Last Name"
                            type="text"
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={(data) => {
                          setaddressShippingRef(data.target.value);
                        }}
                        placeholder="Address"
                        type="email"
                      />
                    ...
                    <Row>
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            name="select"
                            id="exampleSelect"
                            value={countryShippingRef}
                            onChange={(data) => {
                              setcountryShippingRef(data.target.value);
                            }}
                            placeholder="Country"
                          >
                            {Object.keys(countryList)?.map((data, index) => {
                              return (
                                <option value={countryList[data].name}>
                                  {countryList[data].name}
                                </option>
                              );
                            })}
                          </Input>
                      ...
                      <Col lg="6">
                        <FormGroup>
                          <Label for="shippingcountry">Division</Label>

                          <Input
                            type="select"
                            name="division"
                            id="exampleSelect"
                            value={divisionShippingRef}
                            onChange={(data) => {
                              getDistrictList(data.target.value);
                            }}
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            name="division"
                            id="exampleSelect"
                            value={districtShippingRef}
                            onChange={(data) => {
                              setDistrictShippingRef(data.target.value);
                            }}
                            placeholder="Country"
                          >
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            onChange={(data) => {
                              setzipShippingRef(data.target.value);
                            }}
                            placeholder="Zip"
                            type="text"
                          />
                  ...
                  <Form>
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            onChange={(data) => {
                              setfirstnameBillingRef(data.target.value);
                            }}
                            name="first_name"
                            placeholder="First Name"
                            type="email"
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            onChange={(data) => {
                              setlastnameBillingRef(data.target.value);
                            }}
                            name="last_name"
                            placeholder="Last Name"
                            type="text"
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            value={billingPhone}
                            onChange={(data) => {
                              setbillingPhone(data.target.value);
                            }}
                            name="first_name"
                            placeholder="Phone"
                            type="string"
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            onChange={(data) => {
                              setemailBillingRef(data.target.value);
                            }}
                            name="billing_email"
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={(data) => {
                          setaddressBillingRef(data.target.value);
                        }}
                        id="exampleEmail"
                        name="email"
                        placeholder="Address"
                    ...
                    <Row>
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            name="select"
                            id="exampleSelect"
                            value={countryBillingRef}
                            onChange={(data) => {
                              setcountryBillingRef(data.target.value);
                            }}
                            placeholder="Country"
                          >
                            {Object.keys(countryList)?.map((data, index) => {
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            name="division"
                            id="exampleSelect"
                            value={divisionBillingRef}
                            onChange={(data) => {
                              getBillingDistrictList(data.target.value);
                            }}
                            placeholder="Division"
                          >
                            {divisionList?.map((data, index) => {
                      ...
                      <Col lg="6">
                        <FormGroup>
                          <Label for="shippingdistrict">District2</Label>

                          <Input
                            type="select"
                            name="division"
                            id="exampleSelect"
                            value={districtBillingRef}
                            onChange={(data) => {
                              setdistrictBillingRef(data.target.value);
                            }}
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <Input
                            value={zipBillingRef}
                            onChange={(data) => {
                              setzipBillingRef(data.target.value);
                            }}
                            id="exampleEmail"
                            name="zip"
                            placeholder="Zip"
