...
import logo from "../../../src/assets/images/img/logo-01-3.png";
            ...
            <div className="col-lg-6 col-md-6">
              <div className="text-center text-md-start m-3 m-md-0">
                ...
                <p className="text-white">
                  {" "}
                  Hotline:{" "}
                  <a className="text-white" href="tel:+88 01924224778">
                    {" "}
                    +855 0192422477{" "}
                  </a>
                </p>
              ...
              <div className="dropdown">
                <div className="drpMenuItem custopdropdown">
                  <Button
                    ...
                    onClick={handleClick}
                  >
                    <img src={manueing} alt="Menu" /> Shop Categories{" "}
                    <span className="userdropicon">
                      <AiFillCaretDown />
                    </span>
                  </Button>
                  ...
                  >
                    {categoryList.isLoading == false &&
                      categoryList.data?.map((value, index) => {
                        return (
                          ...
                          >
                            <img
                              className="categoryimgdown"
                              src={`${basepath}/${value.image}`}
                              alt=""
                            />
                            <div>{value.name}</div>
                          </MenuItem>
                    ...
                    {showSubcategory && (
                      <div
                        className="subcategory__list__st"
                        ...
                        <ul>
                          {subcategory?.map((value, index) => {
                            return (
                              ...
                              >
                                <li
                                  className="box d-flex itemstyle--set"
                                  key={index}
                                >
      ...
      >
        <div className="cartdropwidth">
          ...
          <Link to={"/checkout"} className="w-100">
            <MenuItem
              className="bottomdivst d-flex justify-content-center"
              style={{
                background: "red",
                background: "#c22026",
                marginBottom: "-8px",
